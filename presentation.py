...
def presentation_page():
    ...
    ---
    ## Ключевые признаки 
    Для большинства моделей ключевыми признаками являются: 
    ...
    ---
    ## Результаты
    - Сравнение моделей: Linear Regression, Random Forest, XGBoost, Ridge Regression
    - Лучшая модель - это Ridge Regression. Она показала R² > 0.0925
